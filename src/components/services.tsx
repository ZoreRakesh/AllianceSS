    ...
    return (
        ...
        <div id="Services">
            <div className="w-full md:h-screen p-20">
                ...
                <p className="text-2xl font-semibold absolute bottom-4 left-2 ">Offshore Service</p>
                </div>
                ...
                <p className="text-2xl font-semibold absolute bottom-4 left-2 ">Inshore Service</p>
                </div>
                <div className="hidden lg:block lg:w-10"></div>
